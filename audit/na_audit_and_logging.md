...
- How **multi‑county and multi‑state list behavior** is documented  
...
## 4.10 Multi‑County and Multi‑State Behavior Must Be Logged  
For **all six entities**:  
- Semicolon‑delimited county list  
- Alphabetical ordering  
- Duplicate detection  
- Source of county assignments  
- Semicolon‑delimited state list (if applicable)  
- Alphabetical ordering  
- Duplicate detection  
...
- Summary of county/state list anomalies  
