...
**PREFIX:** `LUC`  
**Last updated:** 2026-04-29 (Springfield Township VERIFIED; discovery COMPLETE — 348 total records)  
**Status:** DISCOVERY COMPLETE — all tiers done; Springfield Twp verified; ready for pipeline (Resolution → Normalization → GPS → TSV → DB Upsert)
