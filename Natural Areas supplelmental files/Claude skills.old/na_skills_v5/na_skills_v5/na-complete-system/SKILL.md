...
1. **Bootstrap**: Load na-processing-quality skill, establish baseline, initialize session
2. **Discover**: Load na-discovery-workflow skill, execute 8 tiers in order
3. **Resolve**: Run Resolution Engine (na-processing-quality skill)
4. **Normalize**: Load na-normalization-output skill, apply entity rules
