...
# TRAIL NETWORK DISCOVERY SUB-PROCEDURE v5.1
...
This document supersedes all v5.0 and v4.x Trail Network discovery logic.
...
------------------------------------------------------------
# END OF TRAIL NETWORK DISCOVERY SUB-PROCEDURE v5.1
