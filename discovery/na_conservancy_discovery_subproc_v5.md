...
# CONSERVANCY & LAND TRUST DISCOVERY SUB-PROCEDURE v5.1
...
nonprofit conservation landholders within the v5.0 Raw → Resolution → Normalization →
...
The Conservancy & Land Trust Discovery Sub-Procedure v5.0 defines how Tier 7 must:
...
- Document the grant source in `notes_raw`
...
------------------------------------------------------------
# END OF CONSERVANCY & LAND TRUST DISCOVERY SUB-PROCEDURE v5.0
