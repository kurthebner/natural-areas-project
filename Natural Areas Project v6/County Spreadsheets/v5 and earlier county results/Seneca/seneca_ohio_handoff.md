...
**PREFIX:** `SEN`
**County seat:** Tiffin
**Last updated:** 2026-06-12 — PAD-US SPOT-CHECK COMPLETE. MRQ 197 created (3 residuals: Green Springs State Forest, Flatrock Creek WA, Meadowbrook Lake Park). See Supplemental Resolution section below.
**Status:** DISCOVERY COMPLETE — all 8 tiers finished; batch resolution applied 2026-06-10; PAD-US spot-check 2026-06-12. 144 Sites in DB. T-0001 (Sandusky SSR) still held pending Wyandot County run.
...
PAD-US 4.0 Ohio fee layer cross-checked against Seneca DB (144 Sites, 3 Trails).

**Key confirmed matches:**

| PAD-US Unit_Nm | GIS_Acres | DB Match | Notes |
|----------------|-----------|----------|-------|
| Springville Marsh Dedicated Nature Preserve | 201 | S-0002 | ✓ confirmed |
| Knobbys Prairie Wildlife Area | 48 | S-0004 | ✓ confirmed |
| Silver Creek Wildlife Area | 42 | S-0005 | ✓ confirmed |
| Sugar Creek Wildlife Area | 127 | S-0003 | ✓ confirmed |
| Forrest Nature Preserve | 22 | S-0012 | ✓ 22ac + 25ac Addition = 47ac total; matches DB |
| Forrest Nature Preserve Addition | 25 | S-0012 | ✓ both parcels already captured in DB 47ac |
| Garlo Heritage Nature Preserve | 37 | S-0014 | ✓ confirmed; PAD-US 37ac vs DB 292ac (PAD-US is one parcel only) |
| Schekelhoff Park | 35 | S-0035 | ✓ confirmed |
| Fostoria Rail Park | 5 | S-0149 | ✓ confirmed |

**Residuals → MRQ 197:**

| PAD-US Unit_Nm | GIS_Acres | d_Own_Name | Assessment |
|----------------|-----------|------------|------------|
| Green Springs State Forest | 120 | ODNR | **HIGH PRIORITY** — not in DB; Green Springs is in Seneca County; potential T2 gap |
| Flatrock Creek Wildlife Area | 4 | ODNR | Not in DB; Flat Rock Creek flows through Seneca County; potential T2 gap |
| Meadowbrook Lake Park | 4 | City Land | Not in DB; separate from S-0022 (160ac, Hopewell Township); potential T6 gap |

**False positives (confirmed wrong county):** Hopewell Culture NHP (Ross County), Tiffin River WA (NW Ohio rivers), Seneca Lake ×2 (Guernsey/Noble), Senecaville Fish Hatchery (Guernsey), Silver Creek Metropark variants (Medina/Summit).

**Not NAP:** County and city fairgrounds, private golf clubs, school properties.
