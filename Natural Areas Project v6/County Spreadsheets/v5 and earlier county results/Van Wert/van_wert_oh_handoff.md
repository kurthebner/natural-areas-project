...
# Last updated: 2026-06-12 | PIPELINE COMPLETE | PAD-US SPOT-CHECK COMPLETE | MRQ 196 created
...
PAD-US 4.0 Ohio fee layer cross-checked against Van Wert DB (21 Sites, 3 Trails, 0 APs).

**PAD-US entries evaluated (4 genuine candidates after false positive filtering):**

| PAD-US Unit_Nm | GIS_Acres | d_Own_Name | DB Match | Result |
|----------------|-----------|------------|----------|--------|
| Van Wert County Fairgrounds | 89 | County Land | — | NOT NAP — event venue/fairground; no natural character |
| Delphos Golf Club | 156 | Private | — | NOT NAP — private golf; Delphos is Allen/Van Wert border; already seen in Paulding/Putnam checks |
| Blue Creek Conservation Area | 242 | County Land | — | **RESIDUAL — location unverified; could be Van Wert or Auglaize County** |
| Blue Creek Conservation Area | 3 | City Land | — | **RESIDUAL — small city conservation parcel; county unverified** |

**Actions taken:**
- MRQ 196 created: Van Wert PAD-US spot-check residuals — Blue Creek Conservation Area (242ac + 3ac) need county verification

**Key note:** The 242ac Blue Creek Conservation Area (County Land) is the primary concern. Blue Creek flows through both Van Wert and Auglaize counties. If in Van Wert County, it would be a T4 gap — no Van Wert county park district was identified at discovery, but county-owned conservation land is distinct from a park district. Verify via Van Wert County Auditor GIS or Auglaize County Conservation District at next supplemental pass.
...
### Completed
- trail_parents: OH-VNW-T-0003 → OH-VNW-S-0016 (Warrior Trail → Ohio City Fireman's Park) ✓
- GPS S-0019 Van-Del Drive-In: updated 40.852,-84.448 → 40.870157,-84.436806 (Census geocoder, 19986 Lincoln Hwy) ✓
- GPS S-0008 Van Wert Reservoir 1: updated 40.847197,-84.57695 → 40.836715,-84.569956 (GNIS FGDC 1078957) ✓
- Supplemental T6: Wesley Park (S-0020, 3ac) and Bresler Park (S-0021, 8ac) staged + upserted ✓
- manual_review_queue: S-0001 Whitey Case WPA flagged (GPS imprecise, unresolvable from GNIS/PAD-US/USFWS) ✓
- Grover Hill Community Park confirmed Paulding County (bbox false positive) — note for Paulding T6 ✓

### Remaining
- GPS S-0001 Whitey Case WPA: in manual_review_queue; requires ODNR DOW contact or field visit
- Run flags not yet cleared: STORYBOOK_TRAIL_CONFIRM_NEEDED (S-0003), LENGTH_VERIFY_NEEDED (T-0001), DETAILS_INCOMPLETE (S-0016), FIELD_VERIFY_NEEDED (S-0018)
- Ohio City T6 supplemental: confirm Warrior Trail / Ohio City Greenway relationship to S-0016
- Little Auglaize Wildlife Reserve: verify against ODNR; supplement T2 if warranted
- Rotary Park 172ac PAD-US value: confirmed aggregation error (polygon overlaps reservoir); DB entries unchanged
