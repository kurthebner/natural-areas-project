...
# Natural Areas Project v5.2 / v6
# -----------------------------------------------------------

## Handoff Status: PIPELINE COMPLETE — BATCH RESOLUTION APPLIED 2026-06-10
...
Source: Quality review 2026-06-08; see `franklin_oh_batch_resolution_2026_06_10.md` for full detail.

- **SN membership corrections:** S-0825 (Cross Creek Park) removed from Columbus SN → stays Hilliard only; S-0797 (First Responders Park) removed from Hilliard SN → added to Westerville SN
- **+7 supplemental sites:** S-1182–S-1188 (River Bluffs 45ac, Darby Creek Conservation Area 105ac, Glen Echo Ravine 10ac, Brandon Open Space 15ac, Hawks Nest Open Space 15ac, Riverside Woods Open Space 21ac, Woerner-Temple Open Space 5ac) — all confirmed Franklin FIPS 049 via TIGER spatial audit; GPS from PAD-US 4.0
- **Tartan West Open Space (17 parcels):** All confirmed Union County FIPS 159 — bbox false positive; MRQ-flagged for Union County T6 discovery
- **O'Shaughnessy Reservoir (1,279ac):** Delaware County primary — MRQ-flagged for Delaware T2 discovery
- **Final counts:** 1,164 FR sites | SN-0003 Columbus R&P: 547 members | SN-0008 Hilliard: 30 members | SN-0015 Westerville: 30 members

## Open Items (post-batch)
- S-0047 / S-1026: Friendship Park possible duplicate (Prairie Township vs Gahanna, same acreage, GPS 200m) — field verify
- S-1077/1114/1115: Three co-named Mifflin Township cemetery parcels — disambiguate via MORPC parcel data
- S-1183 (Darby Creek Conservation Area): governance verification vs TNC corridor
- S-1184 (Glen Echo Ravine): verify identity vs adjacent S-0180 Glen Echo Park (~155m apart)
- SN-0003 Columbus R&P: systematic membership re-derivation still needed (~60 non-Columbus sites remain in SN); deferred to next pipeline pass
- O'Shaughnessy Reservoir: stage for Delaware County T2 batch
- Tartan West Open Space: stage for Union County T6 batch
- Metro Parks hiking trail trailheads (~90 trails): AP discovery still pending

---

## Prior Status (pre-batch 2026-05-11)
