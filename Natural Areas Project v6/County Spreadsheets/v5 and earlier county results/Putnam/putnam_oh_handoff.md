...
**County:** Putnam, Ohio
**County Seat:** Ottawa
**Last updated:** 2026-06-12 — **PAD-US SPOT-CHECK COMPLETE.** 32 Sites + 3 APs in DB. MRQ 195 created for 3 PAD-US residuals. See Supplemental Resolution section below.
...
PAD-US 4.0 Ohio fee layer cross-checked against Putnam DB (32 Sites + 3 APs).

**PAD-US entries evaluated (7 total):**

| PAD-US Unit_Nm | GIS_Acres | d_Own_Name | DB Match | Result |
|----------------|-----------|------------|----------|--------|
| Ottoville Quarry Wildlife Area | 7 | State | OH-PUT-S-0005 (12.75ac) | CONFIRMED — acreage discrepancy noted (PAD-US 7ac vs DB 12.75ac); note added to S-0005 |
| Auglaize County Fairgrounds | 37 | Local Gov | — | FALSE POSITIVE — Auglaize County (wrong county) |
| Auglaize Country Club | 157 | Private | — | FALSE POSITIVE — Auglaize County (wrong county) |
| Delphos Golf Club | 156 | Private | — | FALSE POSITIVE — Delphos area (Allen/Van Wert/Auglaize, not Putnam) |
| Little Auglaize Wildlife Reserve | 225 | Non-Governmental Org | — | **RESIDUAL — no T7 entities in Putnam DB; potential conservancy gap** |
| Putnam Hill Park | 14 | Local Gov | — | **RESIDUAL — city park not in DB; likely Columbus Grove or Ottawa T6 gap** |
| Putnam Landing Park | 5 | Local Gov | — | **RESIDUAL — small river landing park not in DB; likely Columbus Grove T6 gap** |

**Actions taken:**
- S-0005 (Ottoville Quarry WA): PAD-US acreage discrepancy note appended to `notes` field
- MRQ 195 created: Putnam PAD-US spot-check residuals — 3 items pending next pipeline pass

**Key finding — T7 coverage gap:** Putnam DB has zero T7 conservancy/land trust Sites. "Little Auglaize Wildlife Reserve" (225ac, Non-Gov) is a high-priority gap candidate. The Little Auglaize River flows through Putnam County; BSC and ACRES Land Trust are active in this region but the original T7 pass found no holdings. This warrants targeted follow-up during the next Putnam supplemental run.
