...
# DISCOVERY PROTOCOL MODULE v5.4
...
This module supersedes Discovery Protocol Module v4.0, v5.2, and v5.3.
...
Discovery Protocol v5.3 provides the authoritative, deterministic workflow for
discovering:
...
Discovery Protocol v5.3 governs:
...
------------------------------------------------------------
# 17. DESIGNATION-BASED ENTITY RULES ✨ NEW IN v5.4
...
------------------------------------------------------------
# END OF DISCOVERY PROTOCOL MODULE v5.4