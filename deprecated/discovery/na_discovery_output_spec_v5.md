...
The Discovery Output Specification v5.0 defines the **exact structure** of the
...
## 5.12 `maps_raw`
- Applies to: Trails, Trail Segments, Trail Networks, Site Networks
