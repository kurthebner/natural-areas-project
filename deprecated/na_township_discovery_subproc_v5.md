...
# TOWNSHIP LANDS DISCOVERY SUB-PROCEDURE v5.0
...
township-owned and township-managed natural areas within the v5.0 Raw → Resolution →
...
The Township Lands Discovery Sub-Procedure v5.0 defines how Tier 5 must:
...
------------------------------------------------------------
# END OF TOWNSHIP LANDS DISCOVERY SUB-PROCEDURE v5.0
