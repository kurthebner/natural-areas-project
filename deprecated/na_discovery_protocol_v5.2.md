...
# DISCOVERY PROTOCOL MODULE v5.2
...
Discovery Protocol v5.2 provides the authoritative, deterministic workflow for
discovering:
...
Discovery Protocol v5.2 governs:
...
------------------------------------------------------------
# END OF DISCOVERY PROTOCOL MODULE v5.2