...
- Schema: `na_site_schema_v5.2.md` | Vocabulary: `na_site_vocabulary_v5.2.md`

### Trail
A named, linear, identity-bearing route.
- Schema: `na_trail_schema_v5.1.md` | Vocabulary: `na_trail_vocabulary_v5.1.md`

### Trail Segment
A named or identity-bearing subdivision of a Trail.
- Must have a parent Trail
- Schema: `na_trail_segment_schema_v5.1.md` | Vocabulary: `na_trail_segment_vocabulary_v5.1.md`
...
- Schema: `na_trail_network_schema_v5.1.md` | Vocabulary: `na_trail_network_vocabulary_v5.1.md`
...
- Schema: `na_site_network_schema_v5.1.md` | Vocabulary: `na_site_network_vocabulary_v5.1.md`
...
- Schema: `na_access_point_schema_v5.1.md` | Vocabulary: `na_access_point_vocabulary_v5.3.md`
