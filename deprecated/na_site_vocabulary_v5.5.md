...
- **Exception — Name-keyword inference (IMP-065):** For Nature Preserve, Water Site, Recreation Facility, and Campground, subtype MAY be deterministically inferred from name keywords or description keywords when subtype is blank after vocabulary validation. See §3.4 Subtype Inference Rules. This exception applies only to the four named categories; all other categories must be explicitly documented.
...
------------------------------------------------------------
# END OF SITE VOCABULARY MODULE v5.4