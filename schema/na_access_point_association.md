...
- Dependencies on v3.1 schema and vocabulary modules

This module contains no controlled vocabularies.
All vocabularies referenced here are defined in their respective v3.1 entity
vocabulary modules.
...
- Defines how Access Points may be associated with multiple Trails, Trail
  Segments, Sites, Sub‑Sites, Trail Networks, and Site Networks
...
Must be one of the seven v3.1 ontology types:
...
- Must follow the structure defined in the v3.1 Normalization Contract.
...
This module depends on the following v3.1 schema modules:
...
------------------------------------------------------------
# END OF ACCESS POINT ASSOCIATION MODULE v3.1