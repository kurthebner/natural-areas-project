# NATURAL AREAS PROJECT — SITE NETWORK TSV OUTPUT SPECIFICATION v3.1
A deterministic, formatting‑layer specification defining exactly how Site Network
...
All field definitions are defined in the Site Network Schema Module v3.1.
...
- The canonical v3.1 Site Network TSV field order
- Delimiter rules
- Blank‑field rules
- Whitespace rules
- Derived Label placement rules
- Member Site placement rules
...
- All normalized Site Network records (v3.1)
...
If a Site Network spans multiple counties or states:
...
- `"Heritage Corridor Network (Multi‑State)"`
- `"Watershed Network,"`

------------------------------------------------------------
# 9. MEMBER SITE RULES (v3.1)

## 9.1 Member Sites appear in field 7
- Semicolon‑delimited list of normalized Site names.
- Must match normalized Site names exactly.
...
**Step 1 — Receive normalized 12‑field Site Network record**  
...
- Revalidate Member Site placement
